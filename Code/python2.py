...
def five():
    return [random.randint(50, 100) * 2, random.randint(50, 100) * 2, random.randint(50, 100) * 2,
            random.randint(50, 100) * 2, random.randint(50, 100) * 2]
...
def six(input):
    ...
    if lowerinput[ilen - 1] == "y":
        if lowerinput[ilen - 2] == "p":
            return True
    else:
        return False
